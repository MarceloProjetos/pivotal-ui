...
const routes = {
  ...
  '/alignment': {
    html: AlignmentStuff,
    file: 'components/Alignment.md',
    name: 'Alignment',
    category: 'Components',
    packages: [Alignment]
  },
  '/autocomplete': {
    html: AutocompleteStuff,
    file: 'components/Autocomplete.md',
    name: 'Autocomplete',
    category: 'Components',
  ...
  '/buttons': {
    ...
    sidebar: {
      description: [],
      'basic usage': [],
      styles: ['color', 'alternate treatment', 'sizing'],
      props: []
    },
    '/collapse': {
      html: CollapseStuff,
      file: 'components/Collapse.md',
      name: 'Collapse',
      category: 'Components',
      packages: [Collapse]
    },
    '/copy_to_clipboard': {
      html: CopyToClipboardStuff,
      file: 'components/CopyToClipboard.md',
    ...
    '/layout': {
      html: LayoutStuff,
      file: 'components/Layout.md',
      name: 'Layout',
      category: 'Components',
      packages: [Layout, Trigger]
    },
    '/lists': {
      html: ListsStuff,
      file: 'components/Lists.md',
      name: 'Lists',
      category: 'Components',
      packages: [Lists, DraggableList, StreamList]
    },
    '/media': {html: MediaStuff, file: 'components/Media.md', name: 'Media', category: 'Components', packages: [Media]},
    '/modals': {
      html: ModalsStuff,
      file: 'components/Modals.md',
      name: 'Modals',
      category: 'Components',
      packages: [Modals]
    },
    '/notifications': {
      html: NotificationsStuff,
      file: 'components/Notifications.md',
      name: 'Notifications',
      category: 'Components',
      packages: [Notifications]
    },
    '/pagination': {
      html: PaginationStuff,
